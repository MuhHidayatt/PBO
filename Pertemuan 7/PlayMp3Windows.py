...
class MP3Player:
    def __init__(self, master):
        ...
        self.title_label = tk.Label(self.master, text="Gudang Music", bg=("#F67828"), font=("Helvetica", 16))
        self.title_label.pack(pady=10)

        self.current_file_label = tk.Label(self.master, text="Now Playing: ",bg=("#F67828"), font=("Helvetica", 12), fg=("white"))
    ...
    def open_file_dialog(self):
        ...
        if self.file_path:
            self.current_file_label.configure(text=os.path.basename(self.file_path))
